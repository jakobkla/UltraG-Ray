...
// GS Tile Intersection (Rectangular tiles)
std::tuple<at::Tensor, at::Tensor, at::Tensor> intersect_tile_rectangular(
    const at::Tensor means2d,                    // [..., C, N, 2] or [nnz, 2]
    const at::Tensor radii,                      // [..., C, N, 2] or [nnz, 2]
    const at::Tensor depths,                     // [..., C, N] or [nnz]
    const at::optional<at::Tensor> image_ids,    // [nnz]
...
at::Tensor intersect_offset_rectangular(
    const at::Tensor isect_ids, // [n_isects]
    const uint32_t I,
    const uint32_t tile_width,
    const uint32_t tile_height
...
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor>
rasterize_to_pixels_ultrasound_3dgs_fwd(
    // Gaussian parameters
    const at::Tensor means,          // [..., N, 3]
    const at::Tensor quats,          // [..., N, 4]
    const at::Tensor scales,         // [..., N, 3]
    const at::Tensor intensities,    // [..., C, N, channels] or [nnz, channels]
...
rasterize_to_pixels_ultrasound_3dgs_bwd(
    ...
    const at::Tensor quats,                     // [..., N, 4]
    const at::Tensor scales,                    // [..., N, 3]
    const at::Tensor intensities,               // [..., C, N, 3] or [nnz, 3]
    const at::Tensor transmittances,            // [..., C, N] or [nnz]
    const at::optional<at::Tensor> backgrounds, // [..., C, 3]
    const at::optional<at::Tensor> masks, // [..., C, tile_height, tile_width]
    // image size
    ...
    // forward outputs
    const at::Tensor
        render_ultrasound,          // [..., C, image_height, image_width, 3]
    const at::Tensor render_alphas, // [..., C, image_height, image_width, 1]
    const at::Tensor
        render_transmittances, // [..., C, image_height, image_width, 1]
    const at::Tensor last_ids, // [..., C, image_height, image_width]
    // gradients of outputs
    const at::Tensor
        v_render_ultrasound,          // [..., C, image_height, image_width, 3]
    const at::Tensor v_render_alphas, // [..., C, image_height, image_width, 1]
    const at::Tensor
        v_render_transmittances // [..., C, image_height, image_width, 1]
);
